...
import { ListChecks, FilePenLine, Target, Check, Sparkles, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-white">
            3 AI Tools untuk Membantu Proses Audit
          </h2>
          <p className="text-gray-400 mt-2 text-sm sm:text-base max-w-2xl mx-auto">
            Didesain khusus untuk mengotomasi pekerjaan repetitif dan meningkatkan akurasi analisis auditor internal.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 text-xs mt-3">
            Termasuk 3 AI Tools + AI Assistant AMI dengan Akses Seumur Hidup
          </p>
        </div>
      </div>
    </section>
